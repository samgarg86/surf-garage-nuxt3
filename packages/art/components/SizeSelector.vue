<template>
  <div>
    ...
    <div
      class="text-2 size-selector-grid flex flex-wrap gap-0.5 md:gap-1 font-avenir"
    >
      <div class="size-selector-item">
        <input
          ...
          value="A5"
          class="hidden"
          @change="$emit('update:modelValue', 'A5')"
          :checked="modelValue === 'A5'"
        />
      ...
      <div class="size-selector-item">
        <input
          ...
          value="A4"
          class="hidden"
          @change="$emit('update:modelValue', 'A4')"
          :checked="modelValue === 'A4'"
        />
      ...
      <div class="size-selector-item">
        <input
          ...
          value="A3"
          class="hidden"
          @change="$emit('update:modelValue', 'A3')"
          :checked="modelValue === 'A3'"
        />
