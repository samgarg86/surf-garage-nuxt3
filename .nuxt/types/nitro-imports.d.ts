declare global {
  const __buildAssetsURL: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const cachedEventHandler: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineAppConfig: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nuxt/dist/core/runtime/nitro/config')['defineAppConfig']
  const defineCachedEventHandler: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useAppConfig: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['useAppConfig']
  const useBase: typeof import('h3')['useBase']
  const useNitroApp: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('/Users/samwise/dev/surf-garage/surf-art/node_modules/nitropack/dist/runtime')['useStorage']
